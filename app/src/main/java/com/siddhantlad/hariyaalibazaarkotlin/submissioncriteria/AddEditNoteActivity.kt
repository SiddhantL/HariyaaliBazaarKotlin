...
const val EXTRA_ID = " com.codingwithmitch.navigationcomponentsexample.EXTRA_ID"
const val EXTRA_TITLE = " com.codingwithmitch.navigationcomponentsexample.EXTRA_TITLE"
const val EXTRA_DESCRIPTION = " com.codingwithmitch.navigationcomponentsexample.EXTRA_DESCRIPTION"
const val EXTRA_PRIORITY = " com.codingwithmitch.navigationcomponentsexample.EXTRA_PRIORITY"
...
class AddEditNoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(mode) {
            Mode.AddNote -> title = "Grocery List"
            Mode.EditNote -> {
                title = "Edit Note"
